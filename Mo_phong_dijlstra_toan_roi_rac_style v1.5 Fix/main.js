    ...
    */
    ...
    var checkVerticesStep = function () {
        ...
        if(currentVertex === false) {
            sendInfo("Tất cả các đỉnh đã được duyệt");
    ...
    var checkEdgesStep = function() {
        if(edges.length > 0) checkEdgeStep();
            ...
            sendInfo("Tất cả các cạnh kề xuất phát từ đỉnh này đã được kiểm tra rồi");
    ...
    var endDijkstra = function () {
        sendInfo("<b>Mô phỏng thuật toán đã kết thúc. Cảm ơn thầy cô và các bạn đã xem</b>");
